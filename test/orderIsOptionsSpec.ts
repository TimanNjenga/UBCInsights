...
describe("orderIsOptionsSpec", function () {
...
//new change here
    ...
    let query9 = {
        ...
        "OPTIONS":{
            ...
            "ORDER": {
                "dir": "UP",
                "keys": ["courses_avg", "courses_id","courses_dept"]
            }
        }
    };
    ...
    it("Returns with no order Correctly ",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
                return insightfacade.performQuery(query2)
                    .then(function (response: InsightResponse) {
    ...
    it("Returns sorted with no dir Correctly ",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
    ...
    it("Returns sorted up Correctly ",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
    ...
    it("Returns sorted down Correctly",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
    ...
    it("Returns sorted down Correctly breaking ties ",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
    ...
    it("Returns sorted up Correctly breaking ties ",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
    ...
    it("Returns sorted up Correctly breaking two-tiered ties ",function(){
        return insightfacade.addDataset(astring, contentstring)
            .then ( function (valueonce){
