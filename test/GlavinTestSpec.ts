...
describe("GlavinTestSpecSpec", function () {
...
//new change here
   ...
   //this.timeout (50000);
    ...
    it(" blank dataset - first query for Glavin ",function(){
    ...
    it("add dataset then second query for Glavin",function(){
    ...
    it(" third  query for Glavin ",function(){
    ...
    it(" blank dataset - fourth query for Glavin ",function(){
        return insightfacade.performQuery(query1)
            .then(function ( response: InsightResponse ) {
                // console.log(response.body);
                Log.test('Error: ' + response);
